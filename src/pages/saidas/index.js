...
import { AddCircleOutline, Edit, Numbers, Person, ProductionQuantityLimits, Save, Search } from '@mui/icons-material';
import ButtonComponent from '../../components/button';
import TableComponent from '../../components/table';
import { headerSaida } from '../../entities/headers/header-cadastro/header-saida';
import { saida } from "../../utils/json/saida";
...
const Saidas = () => {
    ...
    const rows = saida.map(saida => ({
      Produto: saida.nome,
      Quantidade: saida.quantidade,
      Solicitado: saida.solicitado,
    }));
  return (
    <div className="md:flex w-[100%] h-[100%]">
      ...
      <div className='flex flex-col gap-2 w-full items-end'>
        ...
        <h1 className='ml-3 text-2xl font-bold text-primary w-[98%] flex gap-2 items-center  '><LogoutIcon />Saídas</h1>
